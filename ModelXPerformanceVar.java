 public class ModelXPerformanceVar extends ModelX {
	  ...
	  public ModelXPerformanceVar(){
		  this.setCarType("Model X (Performance Variant)");
		  this.setSpecs("Long Range", 5498, "2.6 seconds for 0-60 mph", 28, 387, "Driver Display w/ 17\" Touchscreen",
		  "All-Wheel Drive", "250 kW max; Pay Per Use", 5, "11.5 kW max (48A)", 99990); //without wheelSize and warranty
