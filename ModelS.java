  public abstract class ModelS extends TeslaCar {
	  ...
	  public ModelS(){
		  this.setFeatures("- Advanced air filtration system preventing viruses, bacteria and offensive odors from entering the cabin","- Location-aware automatic garage door opener","- Wireless phone charging in center console");
		  this.setCarType("Model S");
