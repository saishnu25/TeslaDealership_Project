  public abstract class ModelY extends TeslaCar{
      ...
      public ModelY(){
          this.setFeatures("- Quick Recharging session(15 min for full battery)","- Highly modded sensors to enable autopilot","- Fully folded chairs for extra cargo space");
		  this.setCarType("Model Y");
