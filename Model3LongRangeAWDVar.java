  public class Model3LongRangeAWDVar extends Model3 {
	  ...
	  public Model3LongRangeAWDVar(){
		  this.setCarType("Model 3 (Long Range AWD Variant)");
		  this.setSpecs("Long Range", 4065, "4.2 seconds 0-60 mph", 15, 353, "15\" Touchscreen",
		  "Dual-Motor All-Wheel Drive", "250 kW max; Pay Per Use", 5, "11.5 kW max (48A)", 46990); //without wheelSize and warranty
